...
<script>
	function doKaiLi2(){
		document.forms[0].action="<%=request.getContextPath()%>/checkapply.action?act=doKaiLi2";
		document.forms[0].submit();
	}
	function doZanCun2(){
		document.forms[0].action="<%=request.getContextPath()%>/checkapply.action?act=doZanCun2";
		document.forms[0].submit();
	}
</script>
	...
	<table border="1" width="80%" class="table table-bordered">
		...
		<tr>
			...
			<td colspan="2" align="right">
				<input type="button" value="暂存" onclick="doZanCun2()" class="btn btn-info"/>
				<input type="button" value="开立" onclick="doKaiLi2()" class="btn btn-info"/>
			</td>
		</tr>
	</table>
</form>
