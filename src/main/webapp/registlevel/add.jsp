...
<br/>
<form action="<%=request.getContextPath()%>/registlevel.action?act=add" method="post">
	...
	<table border="1" width="80%" class="table table-bordered">
		<tr>
			<td>号别编码</td>
			<td>
				<input type="text" name="registCode" />
			</td>
			<td>号别名称</td>
			<td>
		...
		<tr>
			<td>显示顺序号</td>
			<td>
				<input type="text" name="sequenceNo" />
			</td>
			<td>挂号费</td>
			<td>
				<input type="text" name="registFee" />
			</td>
		</tr>
		<tr>
			<td>挂号限额</td>
			<td>
				<input type="text" name="registQuota"/>
			</td>
